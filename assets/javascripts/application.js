...
(function() {
  var growIt, isMobile, isScrolledIntoView, shrinkIt;
  ...
  $(function() {
    ...
    $('.close-slide').on('click', function(e) {
      var offset, target, third;
      e.preventDefault();
      target = $(this).closest('.slide');
      shrinkIt(target);
      third = $('#third');
      offset = third.offset().top;
    ...
    return $('.slide-revealer').on('click', function() {
      ...
      if (target.hasClass('slide--hiding')) {
        growIt(target);
        third = target;
        offset = third.offset().top + third.outerHeight();
        return $('html, body').animate({
          scrollTop: offset
        }, 900);
      } else {
